...
class TeamSeeder extends Seeder
{
    ...
    public function run()
    {
        $teams = [
            ...
            ['name' => 'Краснодар', 'description' => 'Футбольный клуб Краснодар', 'owner_id' => 9],
            ['name' => 'Урал', 'description' => 'Футбольный клуб Урал', 'owner_id' => 10],
            ['name' => 'Оренбург', 'description' => 'Футбольный клуб Оренбург', 'owner_id' => 11],
            ['name' => 'Тамбов', 'description' => 'Футбольный клуб Тамбов', 'owner_id' => 12],
            ['name' => 'Факел', 'description' => 'Футбольный клуб Факел', 'owner_id' => 13],
            ['name' => 'Уфа', 'description' => 'Футбольный клуб Уфа', 'owner_id' => 14],
            ['name' => 'Арсенал', 'description' => 'Футбольный клуб Арсенал', 'owner_id' => 15],
            ['name' => 'Сочи', 'description' => 'Футбольный клуб Сочи', 'owner_id' => 16],
            ['name' => 'Луч-Энергия', 'description' => 'Футбольный клуб Луч-Энергия', 'owner_id' => 17],
